			...
			<div class="col-12">
				<nav class="navbar navbar-expand-lg blur blur-rounded top-0 z-index-3 shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
					<div class="container-fluid pe-0">
						<RouterLink to="/" class="navbar-brand font-weight-bolder ms-lg-0 ms-3 Pretendard-Bold">
							dash.hwahyang.space
						</RouterLink>
						...
						<div class="collapse navbar-collapse Pretendard-Medium" id="navigation">
							<ul class="navbar-nav mx-auto ms-xl-auto me-xl-7" id="navbarParent">
								...
								<li class="nav-item">
									<RouterLink to="/" id="linkText-header" class="nav-link me-2">
										<i aria-hidden class="fa-solid fa-chart-line opacity-6 me-1"></i>
										Dashboard
									</RouterLink>
								</li>
							</ul>
